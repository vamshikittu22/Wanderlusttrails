...
import { FaPlaneDeparture, FaPlaneArrival, FaUsers, FaStar, FaCar, FaShieldAlt, FaSwimmingPool, FaWifi, FaCalendarAlt, FaClock, FaPlane, FaChair  } from 'react-icons/fa';
    ...
    >
      ...
      */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="relative">
          ...
          {showToSuggestions && toSuggestions.length > 0 && (
            ...
            {/* ============================================ */}
      {/* DATES AND FLIGHT TIME SECTION - WITH ICONS */}
      {/* ============================================ */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
        ...
        {/* PREFERRED FLIGHT TIME DROPDOWN - ICON ADDED */}
        <div>
          <label className="flex items-center gap-2 text-indigo-700 font-semibold mb-2">
            <FaClock className="text-blue-500" />
            <span>Preferred Flight Time</span>
          </label>
          <select
            value={flightTime}
          ...
          >
           ...
           {/* ============================================ */}
      {/* AIRLINE AND FLIGHT CLASS SECTION - WITH ICONS */}
      {/* ============================================ */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
        
        {/* PREFERRED AIRLINE DROPDOWN - ICON ADDED */}
        <div>
          <label className="flex items-center gap-2 text-indigo-700 font-semibold mb-2">
        ...
        {/* FLIGHT CLASS DROPDOWN - ICON ADDED */}
        <div>
          <label className="flex items-center gap-2 text-indigo-700 font-semibold mb-2">
            <FaChair className="text-amber-800" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
        ...
        <div>
          ...
          <label className="flex items-center gap-2 text-indigo-700 font-semibold mb-2">
            <FaUsers className="text-stone-700" />
          ...
          */}
          <div>
            ...
            {persons > 1 && insurance !== 'none' && (
              <div className="bg-emerald-50 border-l-4 border-emerald-400 p-3 mb-3 rounded">
